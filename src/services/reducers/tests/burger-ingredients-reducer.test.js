...
describe('Redux burger ingredients reducer', () => {
  it('Should be success BURGER_INGREDIENTS_REQUEST action', () => {
    expect(
      burgerIngredientReducer(undefined, { type: BURGER_INGREDIENTS_REQUEST })
    ).toEqual({
      ...initialState,
      isLoading: true,
    });
  ...
  it('Should be success BURGER_INGREDIENTS_SUCCESS action', () => {
    expect(
  ...
  it('Should be success BURGER_INGREDIENTS_FAILED action', () => {
    expect(
      burgerIngredientReducer(undefined, { type: BURGER_INGREDIENTS_FAILED })
    ).toEqual({
      ...initialState,
      isLoading: false,
      hasError: true,
