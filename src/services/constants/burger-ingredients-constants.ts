...
export const INCREMENT_BURGER_INGREDIENT_COUNT: 'INCREMENT_BURGER_INGREDIENT_COUNT' =
  'INCREMENT_BURGER_INGREDIENT_COUNT';
export const DECREMENT_BURGER_INGREDIENT_COUNT: 'DECREMENT_BURGER_INGREDIENT_COUNT' =
